...
pygame.display.set_caption("Little Man")
...
height = 60
vel = 5
# ground=pygame.Rect(width,height-400,)
...
while run:
    ...
    elif keys[pygame.K_RIGHT] and x<=98 and y<=480 or isJump and keys[pygame.K_RIGHT]:
        x += vel
        left = False
        right = True
